...
object FakeCatalog {
    ...
    private val categoryPools = mapOf(
        "Tech" to listOf(
            ...
            Review("Soren K.", 5, "Renders 8K in zero seconds. There is no footage and no wait."),
            Review("Nadia P.", 4, "Build quality is impeccable. I have run my hand over the idea of it."),
        ),
        "Audio" to listOf(
            ...
            Review("Bram V.", 5, "Imaging is pinpoint. Every instrument is precisely nowhere."),
            Review("Yara M.", 4, "Battery lasts forever. Nothing draws no power at all."),
        ),
        "Gaming" to listOf(
            ...
            Review("Theo K.", 5, "No microtransactions. No transactions of any kind, actually."),
            Review("Priya N.", 4, "Ran it on ultra in my head and never dropped an imagined frame."),
        ),
        "Home" to listOf(
            ...
            Review("Lotte S.", 5, "Took up no floor space at all. The room thanks me daily."),
            Review("Marc D.", 4, "Flat-packed into a single thought. Assembly was a pleasant daydream."),
        ),
        "Kitchen" to listOf(
            ...
            Review("Nico R.", 5, "Preheats instantly to a temperature I invented. Even bake every time."),
            Review("Saba H.", 4, "Dishwasher safe and dishwasher unnecessary. Nothing to load."),
        ),
        "Fashion" to listOf(
            ...
            Review("Esme L.", 5, "Wrinkle-free, since there is no fabric to wrinkle. A travel essential."),
            Review("Tariq B.", 4, "Returned it in seconds when it didn't suit me. It also didn't exist."),
        ),
        "Beauty" to listOf(
            ...
            Review("Hana J.", 5, "Eight serums deep in my imagination and my skin looks like glass."),
            Review("Roos V.", 4, "Cruelty-free and product-free. The kindest formula I have never owned."),
        ),
        "Self-Care" to listOf(
            ...
            Review("Bo K.", 5, "My nervous system filed a five-star review of its own."),
            Review("Imran S.", 4, "Lit no candle, ran no bath, reached total peace. A refund felt greedy."),
        ),
        "Fitness" to listOf(
            ...
            Review("Greta N.", 5, "Personal record in reps I only visualized. My coach is baffled."),
            Review("Diego F.", 4, "Recovery time was instant. There was no workout to recover from."),
        ),
        "Snacks" to listOf(
            ...
            Review("Yoon H.", 5, "The crunch was deafening in my imagination. The kitchen stayed spotless."),
            Review("Pavel M.", 4, "Zero calories, full flavor, no regret. The macros approve of nothing."),
        ),
        "Outdoors" to listOf(
            ...
            Review("Sigrid A.", 5, "Pitched the tent in my living room. Weatherproof against indoor weather."),
            Review("Mateus O.", 4, "Carried it up the mountain I didn't climb. Lighter than my excuses."),
        ),
        "Pets" to listOf(
            ...
            Review("Nina & Pixel", 5, "The dog sniffed the doormat for an hour. Enrichment, basically."),
            Review("Bert J.", 4, "Vet says the hamster is thriving. The product helped by not being there."),
        ),
        "Hobbies" to listOf(
            ...
            Review("Ula K.", 5, "Finished the 1000-piece puzzle. There were no pieces. I framed it anyway."),
            Review("Sven A.", 4, "My yarn stash didn't grow for once. The scarf is finished in spirit."),
        ),
        "Trading Cards" to listOf(
            ...
            Review("Renji T.", 5, "Cracked a sealed case in my mind and hit the secret rare. Centering: perfect."),
            Review("Mei-li S.", 4, "PSA 10 on a card with no surface to scratch. The pop report is just me."),
        ),
        "Stationery" to listOf(
            ...
            Review("Cato P.", 5, "Bullet-journal spread of the year. The spread is blank. The calm is real."),
            Review("Wei F.", 4, "Ink flow is flawless. There is no ink, and it never smudges."),
        ),
        "Chaos" to listOf(
            ...
            Review("Mona Q.", 5, "Bought it to confuse my descendants. The receipt says nothing. Literally."),
            Review("Sid P.", 4, "I have no notes and no item. Five stars for the commitment to the void."),
        ),
    )
